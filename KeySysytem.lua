...
local function ConnectEvents()
    ...
    task.spawn(function()
        ...
        if key == "2946" then
            ShowStatus("Key accepted! Loading script...", false, true)
            task.wait(1)
...
return library
            ...
            SetLoading(false)
            ShowStatus("Invalid Key! Please try again.", true, false)
        end
    end)
end)
